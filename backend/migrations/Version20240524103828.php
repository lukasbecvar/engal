...
/**
 * Class Version20240524103828
 *
 * The database migration for create default database schema
 *
...
final class Version20240524103828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, gallery_name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, length VARCHAR(255) NOT NULL, owner_id INT NOT NULL, token VARCHAR(255) NOT NULL, upload_time VARCHAR(255) NOT NULL, last_edit_time VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
